...
export const getQuizTemplate = () => {
  const id = `quiz-${uuidv4()}`;
  const quizConfig = {
    internal_block_id: id,
    title: "General Science Exam",
    description: "A comprehensive test covering Chemistry, Physics, and Biology concepts.",
    duration: 15,
    questions: [
      {
        id: uuidv4(),
        type: "multiple-choice",
        question: "### Chemical Formulas\nWhat is the chemical formula for **Glucose**?\n\n```smiles\nC(C1C(C(C(C(O1)O)O)O)O)O\n```",
        options: ["C6H12O6", "C12H22O11", "CH4", "H2O"],
      ...
      },
      {
        id: uuidv4(),
        type: "matching",
        question: "### Element Symbols\nMatch the following elements with their correct chemical symbols.",
        pairs: [
          { id: uuidv4(), left: "Gold", right: "Au" },
          { id: uuidv4(), left: "Silver", right: "Ag" },
          { id: uuidv4(), left: "Iron", right: "Fe" }
        ],
        points: 3
      },
      {
        ...
        question: "### Physics Constants\nThe speed of light in a vacuum is approximately $3 \\times 10^8$ [blank].",
        correctAnswer: "m/s",
        points: 1
      },
      {
        id: uuidv4(),
        type: "short-answer",
        question: "### Biology Concepts\nBriefly explain the process of **Photosynthesis** and its importance to life on Earth.",
        points: 5
      }
    ]
  };
